    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Image source={require('@/assets/images/homeHeader.png')} style={styles.headerImage} />
                <Text style={styles.headerText}>What are we cooking today, [username]?</Text>
            ...
            <View style={styles.mealPlanSection}>
                <Image source={require('@/assets/images/homeButton.png')} style={styles.mealPlanImage} />
...
const Section: React.FC<{ title: string }> = ({ title }) => (
    <View style={styles.section}>
        ...
        <View style={styles.sectionContent}>
            <Image style={styles.recipeImage} source={require('@/assets/images/food9.png')} />
            <Image style={styles.recipeImage} source={require('@/assets/images/food4.png')} />
            <Image style={styles.recipeImage} source={require('@/assets/images/food5.png')} />
        </View>
    </View>
);
